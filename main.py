...
from agent_pathfinding_env import *
...
from pygame_ui import GridVisualizer
...
grid_vis = Grid.from_map_string(map_string)

# Set movement pattern again
for do in grid_vis.dynamic_obstacles:
    do.movement_pattern = [(-1, 0)]

agent_vis = Agent(grid_vis.start_pos)

sim_vis = SimulationController(
    grid_vis,
    agent_vis,
    astar_search,
...
visualizer = GridVisualizer(grid_vis, sim_vis)
visualizer.run()